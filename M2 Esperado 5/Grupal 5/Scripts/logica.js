...
function pagarClicked(){
    window.location.href = "/Carrodecompra.html";
}
...
function agregarAlCarritoClicked(event){
    ...
    agregarItemAlCarrito(titulo, precio, codigo, imagenSrc);
 }


//Funciòn que agrega un item al carrito
function agregarItemAlCarrito(titulo, precio, codigo, imagenSrc){
